...
import { IWorkFlowNodeFormModel, WorkFlowNodeFormModel } from '../lib/models/work-flow-node-form.model';
...
export class WorkFlowNodeFormService extends ServiceGenericBase<WorkFlowNodeFormModel> {
   ...
   * @param values
   */
  public async create(values: WorkFlowNodeFormModel, useOptions?: CreateOptions): Promise<WorkFlowNodeFormModel> {
