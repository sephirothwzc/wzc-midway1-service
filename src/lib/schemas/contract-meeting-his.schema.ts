...
export const contractMeetingHisMutationCreate = Joi.object().keys({
  ...
  contractMeetingId: Joi.string().allow('').allow(null).description('合同会议纪要id'),
...
export const contractMeetingHisBulkMutation = Joi.array().items(contractMeetingHisMutationCreate);
// #endregion
