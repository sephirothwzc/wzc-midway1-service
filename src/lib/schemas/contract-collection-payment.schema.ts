...
// #region Graphql
export const contractCollectionPaymentMutationCreate = Joi.object().keys({
  ...
  collectedRemark: Joi.string().allow('').allow(null).description('收款备注'),
  collectedTime: Joi.date().allow(null).description('收款时间'),
  collectionAccountId: Joi.string().allow('').allow(null).description('收款账号id'),
  contractCollectionPlanId: Joi.string().allow('').allow(null).description('合同收款计划id 可以为空'),
  ...
  paymentAccountId: Joi.string().allow('').allow(null).description('付款账号id'),
...
export const contractCollectionPaymentMutationUpdate = Joi.object().keys({
id: Joi.string().allow(''),
  businessCode: Joi.string().allow('').allow(null).description('业务编码权限用'),
  collectedAmount: Joi.number().integer().description('收款金额'),
  collectedProportion: Joi.number().integer().description('收款比例'),
...
export const contractCollectionPaymentBulkMutation = Joi.array().items(contractCollectionPaymentMutationCreate);
// #endregion
