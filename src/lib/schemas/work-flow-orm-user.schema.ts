...
export const workFlowOrmUserMutationCreate = Joi.object().keys({
  ...
  managerUserId: Joi.string().allow('').allow(null).description('经手人类型AppUser,Role,RoleGroup,的id'),
  ...
  undertakeUserId: Joi.string().allow('').allow(null).description('承办人类型AppUser,Role,RoleGroup,的id'),
  undertakeUserType: Joi.string().allow('').allow(null).description('承办人类型AppUser,Role,RoleGroup,的id'),
  updatedAt: Joi.date().allow(null).description('修改时间'),
  updatedId: Joi.string().allow('').allow(null).description('修改人id'),
  workFlowOrmId: Joi.string().allow('').allow(null).description('发起人id'),
});
