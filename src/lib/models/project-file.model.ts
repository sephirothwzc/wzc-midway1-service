 ...
 * 项目文件
 */
export type IProjectFileModel = typeof ProjectFileModel;
...
export class ProjectFileModel extends BaseModel {
  /**
   * 业务编码权限用
   */
...
export const factory = () => ProjectFileModel;
providerWrapper([
  {
    id: 'projectFileModel',
    provider: factory,
