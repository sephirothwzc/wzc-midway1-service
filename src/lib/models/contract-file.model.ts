 ...
 * 合同文件
 */
export type IContractFileModel = typeof ContractFileModel;
...
export class ContractFileModel extends BaseModel {
  /**
   * 业务编码权限用
   */
...
export const factory = () => ContractFileModel;
providerWrapper([
  {
    id: 'contractFileModel',
    provider: factory,
  },
]);
