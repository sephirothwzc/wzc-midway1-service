 ...
 * 合同收款计划历史
 */
export type IContractCollectionPaymentPlanHisModel = typeof ContractCollectionPaymentPlanHisModel;
...
export class ContractCollectionPaymentPlanHisModel extends BaseModel {
  ...
  @BelongsTo(() => ContractCollectionPaymentPlanModel, 'contract_collection_payment_plan_id')
...
export class CONTRACT_COLLECTION_PAYMENT_PLAN_HIS {
   ...
   * 合同收款计划id
   */
  static readonly CONTRACT_COLLECTION_PAYMENT_PLAN_ID: string = 'contractCollectionPaymentPlanId';
